...
st.sidebar.markdown("""
[Example CSV input file](https://github.com/Sanjana-Ghosh/Technocolabs-Internship-Project/blob/master/Mini-Project-2/Credit-example.csv)
""")
...
def user_input_features():
    ...
    PAY_1 = st.sidebar.slider('PAY_1',0,1000000,5000)
    BILL_AMT1 = st.sidebar.slider('BILL_AMT1',0,1000000,5000)
    BILL_AMT2 = st.sidebar.slider('BILL_AMT2',0,1000000,10000)
    BILL_AMT3 = st.sidebar.slider('BILL_AMT3',0,1000000,5000)
    BILL_AMT4 = st.sidebar.slider('BILL_AMT4',0,1000000,3000)
    BILL_AMT5 = st.sidebar.slider('BILL_AMT5',0,1000000,7000)
    BILL_AMT6 = st.sidebar.slider('BILL_AMT6',0,1000000,5000)
    PAY_AMT1 = st.sidebar.slider('PAY_AMT1',0,1000000,5000)
    PAY_AMT2 = st.sidebar.slider('PAY_AMT2',0,1000000,8000)
    PAY_AMT3 = st.sidebar.slider('PAY_AMT3',0,1000000,2000)
    PAY_AMT4 = st.sidebar.slider('PAY_AMT4',0,1000000,3000)
    PAY_AMT5 = st.sidebar.slider('PAY_AMT5',0,1000000,7000)
    PAY_AMT6 = st.sidebar.slider('PAY_AMT6',0,1000000,5000)
...
load_clf = pickle.load(open('credit_card_clf3.pkl', 'rb'))
